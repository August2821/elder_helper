...
public class order10 extends AppCompatActivity {
ImageButton button;
ImageView iv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.order10);

        button=findViewById(R.id.paybutton);

        button.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(getApplicationContext(), orderfinish.class);
                startActivity(intent);
            }
        });

        iv= findViewById(R.id.rbpay);
